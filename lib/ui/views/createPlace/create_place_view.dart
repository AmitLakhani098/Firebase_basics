...
import 'package:firebase_basics/ui/views/createPlace/create_place_view_model.dart';
...
class CreatePlaceView extends StatefulWidget {
  @override
  _CreatePlaceViewState createState() => _CreatePlaceViewState();
}
...
class _CreatePlaceViewState extends State<CreatePlaceView> {
  ...
  Widget build(BuildContext context) {
    return ViewModelProvider<CreatePlaceViewModel>.withConsumer(
      ...
      viewModelBuilder: () => CreatePlaceViewModel(),
    );
  }
}
